...
legend({'MLE: \mu+\sigma','MLE: \mu','MLE: \mu-\sigma',...
       ...
       'The Truth'},'FontSize',11,'Location','WestOutside');
saveas(h,['data/synth-1/figall/' 'meanvarbyk_' dataDist '-all_d' num2str(d) '_n' num2str(n) '_q' num2str(q) '_k' num2str(ks(1)) '-' num2str(ks(end)) '_runs' num2str(r) '.fig']);
saveas(h,['data/synth-1/figall/' 'meanvarbyk_' dataDist '-all_d' num2str(d) '_n' num2str(n) '_q' num2str(q) '_k' num2str(ks(1)) '-' num2str(ks(end)) '_runs' num2str(r) '.png']);
saveas(h,['data/synth-1/figall/' 'meanvarbyk_' dataDist '-all_d' num2str(d) '_n' num2str(n) '_q' num2str(q) '_k' num2str(ks(1)) '-' num2str(ks(end)) '_runs' num2str(r) '.eps'],'epsc');
