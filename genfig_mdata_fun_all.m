function genfig_mdata_fun_all(dataSet,ks)
...
for i = 1:numks
    ...
    saveas(h,['data/m10000/figall/' 'boxplot-' dataSet '-k' num2str(k) '.fig']);
    saveas(h,['data/m10000/figall/' 'boxplot-' dataSet '-k' num2str(k) '.png']);
    saveas(h,['data/m10000/figall/' 'boxplot-' dataSet '-k' num2str(k) '.eps'],'epsc');
    close(h);
end
