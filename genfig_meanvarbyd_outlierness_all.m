...
legend({'MLE: \mu+\sigma','MLE: \mu','MLE: \mu-\sigma',...
       ...
       'MiND ml1','MiND mli','The Truth'},'FontSize',11,'Location','WestOutside');
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-all_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.fig']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-all_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.png']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-all_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.eps'],'epsc');
...
legend({'MLE: \mu+\sigma','MLE: \mu','MLE: \mu-\sigma',...
       ...
       'LPCA: \mu+\sigma','LPCA: \mu','LPCA: \mu-\sigma',...
       'MiND ml1','MiND mli','The Truth'},'FontSize',11,'Location','WestOutside');
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-outliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.fig']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-outliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.png']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-outliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.eps'],'epsc');
...
legend({'MLE: \mu+\sigma','MLE: \mu','MLE: \mu-\sigma',...
       ...
       'LPCA: \mu+\sigma','lPCA: \mu','LPCA: \mu-\sigma',...
       'MiND ml1','MiND mli','The Truth'},'FontSize',11,'Location','WestOutside');
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-inliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.fig']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-inliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.png']);
saveas(h,['data/synth-1/figall/' 'meanvar5AllDim_' dataDist '-inliers_d' num2str(min(ds)) '-' num2str(max(ds)) '_n' num2str(n) '_q' num2str(q) '_k' num2str(k) '_runs' num2str(r) '.eps'],'epsc');
